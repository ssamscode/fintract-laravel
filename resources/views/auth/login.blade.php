...
<div class="min-h-screen grid lg:grid-cols-2">
    ...
    <div
        ...
        <p class="text-xl leading-9 text-center max-w-md">
            ...
            and build better financial habits with FinTrack.
...
<div x-data="{ show: false }">
    ...
    <div class="relative">
        ...
        <button
            type="button"
            @click="show = !show"
            class="absolute inset-y-0 right-4 flex items-center text-gray-500 hover:text-[#235347] transition">
            ...
            <svg x-show="show"
                ...
                <path stroke-linecap="round"
                    stroke-linejoin="round"
                    d="M10.58 10.58A2 2 0 0012 14
                    a2 2 0 001.42-.58M9.88 5.09A9.77 9.77 0 0112 5
                    c4.48 0 8.27 2.94 9.54 7
                    a9.96 9.96 0 01-4.04 5.14M6.23 6.23
                    A9.96 9.96 0 002.46 12
                    c1.27 4.06 5.06 7 9.54 7
                    a9.8 9.8 0 004.28-.97" />
    ...
    <x-input-error
        ...
        class="mt-2"/>
                ...
                <div class="flex justify-between items-center">
                    ...
                    @if(Route::has('password.request'))
                        ...
                        <a
                            ...
                            class="text-[#235347] hover:underline">
                ...
                <button
                    type="submit"
                    class="w-full rounded-xl bg-[#235347] py-4 text-lg font-semibold text-white transition hover:bg-[#1B4332]">
                ...
                <button
                    type="button"
                    class="w-full rounded-xl border border-gray-300 py-4 font-semibold hover:bg-gray-100">
